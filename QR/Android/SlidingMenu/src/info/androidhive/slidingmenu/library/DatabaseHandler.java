...
public class DatabaseHandler extends SQLiteOpenHelper {
     ...
     * */
    public void addUser(String fname, String lname, String email, String uname, String address1,
        ...
        values.put(KEY_ADDRESS1, address1); // Address1
        values.put(KEY_ADDRESS2, address2); // Address2
        values.put(KEY_CITY, city); // City
        values.put(KEY_STATE, state); // State
        values.put(KEY_POSTAL, postal); // Postal
    ...
    public void updateProfile(String fname, String lname, String address1,
    		String address2, String city, String state, String postal, String country, String phone) {
    	SQLiteDatabase db = this.getWritableDatabase();
    	ContentValues values = new ContentValues();
        values.put(KEY_FIRSTNAME, fname); // FirstName
        ...
        values.put(KEY_COUNTRY, country); // Country
        values.put(KEY_PHONE, phone); // Phone
        db.update(TABLE_LOGIN, values, KEY_ID, null);
